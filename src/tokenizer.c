/*
 * A tokenizer must:
 * - Given a list of tokens (i.e. vocab) of return a map that links a word with an integer;
 * - Must have encode/decode functions for a list and a single value
 * - It should be able to tokenize (i.e. break raw text into pieces and map into an integer - encode)
 * */
